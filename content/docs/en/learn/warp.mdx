...
<Callout type="info">
  **Docker Configuration for Xray WireGuard Outbound:**
  If you are running PasarGuard Node using Docker, add the following lines to your `docker-compose.yml` file under the service definition for WireGuard outbound to function properly:
