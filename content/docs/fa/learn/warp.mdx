...
<ImageZoom
  ...
  alt="باز کردن ترمینال در File Explorer"
  width={800}
  height={400}
/>
...
<Callout type="info">
  **تنظیمات داکر برای Xray WireGuard Outbound:**
  اگر نود پاسارگارد را با داکر اجرا می‌کنید، برای کارکرد صحیح WireGuard outbound خطوط زیر را به فایل `docker-compose.yml` اضافه کنید:
